...
cols = st.columns(5)
with cols[0]:
    tac = st.text_area("木育を実践する場である保育・教育施設における実証実験による新たなアイデア獲得の機会創出、大手ECサイトへの出店による販売チャネルの拡大、社長の子息の経営学の知識やX事業での経験による、SNSを活用した情報発信や子育てイベントへの出展などの積極的な企画・実行など、ターゲット層を意識した内容を実施した。", height=180, placeholder="TACの模範解答を貼り付け")
with cols[1]:
    lec = st.text_area("取組は、直営店やアンテナショップ、イベントや保育・教育施設、大手ECサイトやSNS、ワークショップである。工夫は、公共団体との良好な関係や社長の子息のX事業での経験を活かし、PRや情報発信を強化した。また、顧客が製品に触れる機会や学生との共同研究機械を作り、市場の成長可能性や新たなアイデアを探索した。", height=180, placeholder="LECの模範解答を貼り付け")
with cols[2]:
    ohara = st.text_area("行った取り組みは、従来のルートとは異なる新たな販売チャネルの構築である。20代から40代の教育熱心な子育て家庭との接点をもつために、大手ECサイトへ出店した。工夫は、①SNSを活用した情報発信や子育てイベントへの出展等による認知度向上、②地元の大学との教育連携の推進による製品開発サイクルのj加速う、等である。", height=180, placeholder="大原の模範解答を貼り付け")
with cols[3]:
    kec = st.text_area("取組みは、自社併設の直営店や県のアンテナショップ・大手ECサイトでの販売の他、SNSを活用した情報発信や子育てイベントへの出展である。工夫は、ターゲットを教育熱心な家庭とし、地元の県や大学との関係を生かした保育・教育施設において子供たちが日常的にA社製品に触れる機会を作り、新製品のアイデアに繋げた。", height=180, placeholder="KECの模範解答を貼り付け")
with cols[4]:
